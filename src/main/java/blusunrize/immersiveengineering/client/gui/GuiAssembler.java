	...
	protected void drawGuiContainerBackgroundLayer(float f, int mx, int my)
	{
		...
		for(int i=0; i<tile.patterns.length; i++)
			if(tile.inventory[18+i]==null && tile.patterns[i].inv[9]!=null)
			{
				...
				itemRender.renderItemAndEffectIntoGUI(font, this.mc.getTextureManager(), stack, guiLeft+27+i*58, guiTop+64);
				itemRender.renderItemOverlayIntoGUI(font, this.mc.getTextureManager(), stack, guiLeft+27+i*58, guiTop+64, EnumChatFormatting.GRAY.toString()+stack.stackSize);
				this.zLevel = 0.0F;
