...
{
	public class CachedSqueezerRecipe extends CachedRecipe
	{
		PositionedStack input;
		PositionedStack output;
		FluidStack fluid;
		public int time;
		public CachedSqueezerRecipe(SqueezerRecipe recipe)
		{
	...
	{
		transferRects.add(new RecipeTransferRect(new Rectangle(72,12, 30,14), "ieSqueezer"));
		transferRects.add(new RecipeTransferRect(new Rectangle(72,44, 30,14), "ieSqueezer"));
	}
	@Override
	public void loadCraftingRecipes(String outputId, Object... results)
	{
		...
		for(SqueezerRecipe r : DieselHandler.squeezerList)
			if(r!=null)
	...
	public void loadUsageRecipes(ItemStack ingredient)
	{
		if(ingredient!=null)
		{
			SqueezerRecipe r = DieselHandler.findSqueezerRecipe(ingredient);
			if(r!=null)
				this.arecipes.add(new CachedSqueezerRecipe(r));
		}
	}
